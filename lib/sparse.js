...
(function() {
  ...
  sparse.getConstructorName = function(fun) {
    var name;
    return fun.constructor.name || ((name = sparse.getFunctionName(fun.constructor)) != null ? name : sparse.UNDEFINED_CLASSNAME);
  };

  sparse.getFunctionName = function(fun) {
    var n;
  ...
  sparse.Collection = (function(_super) {
    ...
    Collection.prototype.sync = function(__method, model, options) {
      ...
      opts.data = !this.__query ? JSON.stringify(this.toJSON()) : "where=" + (this.__query.toJSON());
    ...
    Collection.prototype.query = function() {
      if (this.__query == null) {
        this.__query = new sparse.Query(this.className);
      }
      return this.__query;
    };
    ...
    Collection.prototype.count = function(bool) {
      return this.__params.count = bool || true;
    };
  ...
  sparse.Collection.equalTo = function(col, value) {
    return (new this).equalTo(col, value);
  };

  sparse.Collection.notEqualTo = function(col, value) {
    return (new this).notEqualTo(col, value);
  };

  sparse.Collection.greaterThan = function(col, value) {
    return (new this).greaterThan(col, value);
  };

  sparse.Collection.greaterThanOrEqualTo = function(col, value) {
    return (new this).greaterThanOrEqualTo(col, value);
  };

  sparse.Collection.lessThan = function(col, value) {
    return (new this).lessThan(col, value);
  };

  sparse.Collection.lessThanOrEqualTo = function(col, value) {
    return (new this).lessThanOrEqualTo(col, value);
  };

  sparse.Collection.contains = function(col, value) {
    return (new this).contains(col, value);
  };

  sparse.Collection.containsAll = function(col, array) {
    return (new this).containsAll(col, array);
  };

  sparse.Collection.containedIn = function(col, array) {
    return (new this).containedIn(col, array);
  };

  sparse.Collection.notContainedIn = function(col, array) {
    return (new this).notContainedIn(col, array);
  };

  sparse.Collection.inQuery = function(col, query) {
    return (new this).inQuery(col, query);
  };

  sparse.Collection.notInQuery = function(col, query) {
    return (new this).notInQuery(col, query);
  };

  sparse.Collection.or = function() {
    var queries;
    queries = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return (new this).or(queries);
  };

  sparse.Collection.include = function(value) {
    return (new this).include = value;
  };

  sparse.Collection.keys = function(array) {
    return (new this).keys = value;
  };

  sparse.Collection.count = function(bool) {
    return (new this).count = bool;
  };

  sparse.Collection.order = function(value) {
    return (new this).order = value;
  };

  sparse.Collection.limit = function(value) {
    return (new this).limit = value;
  };

  sparse.Collection.skip = function(value) {
  ...
  sparse.Query = (function() {
    ...
    Query.prototype._or = function() {
      var queries, _base;
      queries = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      return this.__q['$or'] = _.concat(((_base = this.__q)['$or'] != null ? _base['$or'] : _base['$or'] = []), _.map(queries, (function(_this) {
        return function(v, k) {
          return v.__q;
        };
      })(this)));
