...
(function() {
  ...
  sparse.Model = (function(_super) {
    ...
    function Model(attributes, options) {
      ...
      if (typeof this.__parse_classname === 'undefined' || this.__parse_classname === null) {
        this.__parse_classname = sparse.getConstructorName(this);
      }
      if (this.__parse_classname === sparse.UNDEFINED_CLASSNAME) {
        console.warn("sparse.Collection requires __parse_classname to be defined");
      }
      this.__parse_classname = sparse.Inflection.pluralize(this.__parse_classname);
    }

    Model.prototype.url = function() {
      return "" + sparse.API_URI + "/classes/" + this.__parse_classname + (!this.isNew() ? '/' + (this.get('objectId')) : '');
    };
  ...
  sparse.Collection = (function(_super) {
    ...
    Collection.prototype.url = function() {
      ...
      return encodeURI("" + sparse.API_URI + "/classes/" + this.__parse_classname + (this.__method === 'read' && (p = this.getParams()).length ? '?' + p : ''));
    };
    ...
    Batch.prototype._prepareModel = function(attrs, options) {
      ...
      if (options.destroy && this._memberIsNew(attrs)) {
        ...
        obj = {
          ...
          path: "/" + sparse.API_VERSION + "/classes/" + attrs.__parse_classname + (!this._memberIsNew(attrs) ? '/' + attrs.get('objectId') : '')
        };
        if (!options.destroy) {
          obj.body = attrs;
        }
