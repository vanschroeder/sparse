...
(function() {
  var Backbone, global, sparse, _, _ref, _ref1,
  ...
  sparse._encode = function(value, seenObjects, disallowObjects) {
    ...
    if (!seenObjects || _.include(seenObjects, value) || value.attributes !== value.defaults) {
  ...
  sparse.Object = (function(_super) {
    ...
    function Object(attrs, opts) {
      ...
      if (((_ref = this.className) != null ? _ref : this.className = sparse.getConstructorName(this)) === sparse.UNDEFINED_CLASSNAME) {
    ...
    Object.prototype.sync = function(method, model, options) {
      ...
      sparse.validateRoute((_ref = options.url) != null ? _ref : options.url = _.result(this, 'url') || '/');
    ...
    Object.prototype._finishFetch = function(serverData, hasData) {
      ...
      _.each(serverData, function(v, k) {
    ...
    Object.prototype._mergeMagicFields = function(attrs) {
      ...
      return _.each(['id', 'objectId', 'createdAt', 'updatedAt'], function(attr) {
        if (attrs[attr]) {
          switch (attrs[attr]) {
            case 'objectId':
              _this.id = attrs[attr];
  ...
  sparse.Object._getSubclass = function(className) {
    var clazz, _base, _ref;

    if (!_.isString(className)) {
      throw 'sparse.Object._getSubclass requires a string argument.';
    }
    return (_ref = (_base = sparse.Object._classMap)[className]) != null ? _ref : _base[className] = (clazz = sparse.Object._classMap[className]) ? clazz : sparse.Object.extend(className);
  };
  ...
  sparse.Object.saveAll = function(list, options) {
    ...
    return (new sparse.Batch(list)).exec(options({
  ...
  sparse.Object.destroyAll = function(list, options) {
    ...
    return (new sparse.Batch).destroy(list, options({
      complete: function(m, r, o) {
        if (options.success) {
          return options.success(m, r, o);
        }
  ...
  sparse.Query = (function(_super) {
    ...
    Query.prototype.set = function(col, key, val) {
      ...
      if (col != null) {
        if ((_ref2 = (_base = this.__q)[col]) == null) {
          _base[col] = {};
        }
      }
    ...
    Query.prototype.getParams = function() {
      ...
      return (_.map(_.pairs(this.__q, function(v, k) {
        return v.join('=');
      }))).join('&');
    };
    ...
    Query.prototype.relatedTo = function(object) {
      if (!object.get || object.get('objectId' === null || typeof object.__parse_classname === 'undefined')) {
        console.error('Parsely.Statement.$relatedTo required object be of Type Parsely.Model');
      }
      return this.set(null, "$relatedTo", {
        __type: "Pointer",
        objectId: object.get('objectId'),
        className: object.__parse_classname
      });
    };
  ...
  sparse.Query.or = function() {
    ...
    className = null;
    _.each((Qs = _.toArray(arguments)), function(q) {
